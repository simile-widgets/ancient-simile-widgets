...
SimileAjax.DOM.getEventPageCoordinates=function(A){if(SimileAjax.Platform.browser.isIE){var B=0;
var C=0;
if(document.body&&(document.body.scrollLeft||document.body.scrollTop)){B=document.body.scrollTop;
