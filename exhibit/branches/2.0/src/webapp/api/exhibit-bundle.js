...
Exhibit.CloudFacet._settingSpecs={"facetLabel":{type:"text"},"showMissing":{type:"boolean",defaultValue:true}};
...
Exhibit.CloudFacet.prototype._computeFacet=function(H){var G=this._uiContext.getDatabase();
var F=[];
var P="text";
