...
/* curate-extension.js */
(function(){var isCompiled=("Exhibit_CurateExtension_isCompiled" in window)&&window.Exhibit_CurateExtension_isCompiled;
Exhibit.CurateExtension={params:{bundle:false}};
var javascriptFiles=["change-list.js","item-creator.js","scraper.js","submission-backend.js","submission-widgets.js"];
var cssFiles=["change-list.css","scraper.css"];
...
if("Exhibit_CurateExtension_parameters" in window){SimileAjax.parseURLParameters(Exhibit_CurateExtension_parameters,Exhibit.CurateExtension.params,paramTypes);
}}else{var url=SimileAjax.findScript(document,"/curate-extension.js");
if(url==null){SimileAjax.Debug.exception(new Error("Failed to derive URL prefix for Simile Exhibit Curate Extension code files"));
return ;
...
/* curate-extension-bundle-debug.js */
