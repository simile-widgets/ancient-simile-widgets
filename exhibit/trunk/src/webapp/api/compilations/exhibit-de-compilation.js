...
var B=[];
var A=Exhibit.urlPrefix+"locales/de/";
if(Exhibit.params.bundle){SimileAjax.includeJavascriptFiles(document,A,["exhibit-de-bundle.js"]);
if(B.length>0){SimileAjax.includeCssFiles(document,A,["exhibit-de-bundle.css"]);
}}else{SimileAjax.includeJavascriptFiles(document,A+"scripts/",D);
SimileAjax.includeCssFiles(document,A+"styles/",B);
}}})();


/* exhibit-de-bundle.js */
...
Exhibit.l10n.badJsonMessage=function(C,D){return"Die JSON Datei\n  "+C+"\nenthält Fehler =\n\n"+D;
};
Exhibit.l10n.failedToLoadDataFileMessage=function(B){return"Die Datei\n  "+B+"\nkann nicht gefunden werden. Bitte überprüfen Sie den Dateinamen.";
};
...
Exhibit.OrderedViewFrame.l10n.formatSortActionTitle=function(D,C){return"Sortiert nach "+D+" ("+C+")";
};
Exhibit.OrderedViewFrame.l10n.formatRemoveOrderActionTitle=function(D,C){return"Hebe Sortierung nach "+D+" auf ("+C+")";
};
...
Exhibit.OrderedViewFrame.l10n.formatDontShowAll=function(B){return"Zeige nur die ersten "+B+" Ergebnisse";
};
Exhibit.OrderedViewFrame.l10n.formatShowAll=function(B){return"Zeige alle "+B+" Ergebnisse";
};
...
Exhibit.TabularView.l10n.makeSortActionTitle=function(C,D){return(D?"aufsteigend sortiert nach ":"absteigend sortiert nach ")+C;
};
...
}Exhibit.ViewPanel.l10n.createSelectViewActionTitle=function(B){return"Wähle Sicht "+B;
};
Exhibit.ViewPanel.l10n.missingViewClassMessage="Der Beschreibung einer der Sichten fehlt das viewClass Attribut.";
Exhibit.ViewPanel.l10n.viewClassNotFunctionMessage=function(B){return"Der angegebene Wert '"+B+"' des viewClass Attributs\neiner der Sichten ist keine Javascript Funktion.";
};
Exhibit.ViewPanel.l10n.badViewClassMessage=function(B){return"Der angegebene Wert '"+B+"' des viewClass Attributs\neiner der Sichten ist kein gültiger Javascript Ausdruck.";
};
...
return String.substitute("<a class='exhibit-action exhibit-views-unplottableCount' href='javascript:void' id='unplottableCountLink'>%0</a> von <class class='exhibit-views-totalCount'>%1</span> können nicht angezeigt werden.",[F==1?(F+" Ergebnis"):(F+" Ergebnisse"),H]);
};
