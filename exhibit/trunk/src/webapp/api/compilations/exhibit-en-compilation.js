...
var B=[];
var A=Exhibit.urlPrefix+"locales/en/";
if(Exhibit.params.bundle){SimileAjax.includeJavascriptFiles(document,A,["exhibit-en-bundle.js"]);
if(B.length>0){SimileAjax.includeCssFiles(document,A,["exhibit-en-bundle.css"]);
}}else{SimileAjax.includeJavascriptFiles(document,A+"scripts/",D);
SimileAjax.includeCssFiles(document,A+"styles/",B);
}}})();


/* exhibit-en-bundle.js */
...
Exhibit.l10n.badJsonMessage=function(C,D){return"The JSON data file\n  "+C+"\ncontains errors =\n\n"+D;
};
Exhibit.l10n.failedToLoadDataFileMessage=function(B){return"We cannot locate the data file\n  "+B+"\nCheck that the file name is correct.";
};
...
Exhibit.OrderedViewFrame.l10n.formatSortActionTitle=function(D,C){return"Sorted by "+D+" ("+C+")";
};
Exhibit.OrderedViewFrame.l10n.formatRemoveOrderActionTitle=function(D,C){return"Removed order by "+D+" ("+C+")";
};
...
Exhibit.OrderedViewFrame.l10n.formatDontShowAll=function(B){return"Show only the first "+B+" results";
};
Exhibit.OrderedViewFrame.l10n.formatShowAll=function(B){return"Show all "+B+" results";
};
...
Exhibit.OrderedViewFrame.l10n.makePagingActionTitle=function(B){return("Page "+(B+1));
};
Exhibit.OrderedViewFrame.l10n.makePagingLinkTooltip=function(B){return("Go to page "+(B+1));
};
...
Exhibit.TabularView.l10n.makeSortActionTitle=function(C,D){return(D?"sorted ascending by ":"sorted descending by ")+C;
};
...
}Exhibit.ViewPanel.l10n.createSelectViewActionTitle=function(B){return"select "+B+" view";
};
Exhibit.ViewPanel.l10n.missingViewClassMessage="The specification for one of the views is missing the viewClass field.";
Exhibit.ViewPanel.l10n.viewClassNotFunctionMessage=function(B){return"The viewClass attribute value '"+B+"' you have specified\nfor one of the views does not evaluate to a Javascript function.";
};
Exhibit.ViewPanel.l10n.badViewClassMessage=function(B){return"The viewClass attribute value '"+B+"' you have specified\nfor one of the views is not a valid Javascript expression.";
};
