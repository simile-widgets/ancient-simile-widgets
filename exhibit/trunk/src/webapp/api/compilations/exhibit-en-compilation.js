...
Exhibit.TabularView.l10n.makePagingActionTitle=function(B){return("Page "+(B+1));
};
Exhibit.TabularView.l10n.makePagingLinkTooltip=function(B){return("Go to page "+(B+1));
};
