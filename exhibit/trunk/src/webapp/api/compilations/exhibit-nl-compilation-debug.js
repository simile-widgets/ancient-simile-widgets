...
Exhibit.TsvCsvImporter.parseTsvCsv=function(text,format,expressionString,removeFirstLine){var separator=Exhibit.TsvCsvImporter.formatType(format);
var lines=text.split("\n");
var noPropertyNames=expressionString!=null;
var exString;
if(removeFirstLine){lines=line.slice(1);
}if(noPropertyNames&&separator=="\t"){exString=Exhibit.TsvCsvImporter.replaceAll(expressionString,",","\t");
}var propertyRow=noPropertyNames?exString.split(separator):lines[0].split(separator);
...
var type="";
if(prop.match(":")){prop=prop.substring(0,prop.lastIndexOf(":"));
