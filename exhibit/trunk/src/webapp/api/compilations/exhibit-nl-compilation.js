...
var B=[];
var A=Exhibit.urlPrefix+"locales/nl/";
if(Exhibit.params.bundle){SimileAjax.includeJavascriptFiles(document,A,["exhibit-nl-bundle.js"]);
if(B.length>0){SimileAjax.includeCssFiles(document,A,["exhibit-nl-bundle.css"]);
}}else{SimileAjax.includeJavascriptFiles(document,A+"scripts/",D);
SimileAjax.includeCssFiles(document,A+"styles/",B);
}}})();


/* exhibit-nl-bundle.js */
...
Exhibit.l10n.badJsonMessage=function(C,D){return"De JSON-data\n  "+C+"\nbevat fouten =\n\n"+D;
};
Exhibit.l10n.failedToLoadDataFileMessage=function(B){return"De data\n  "+B+"\nkan niet gevonden worden. Is de bestandsnaam wel correct?";
};
...
Exhibit.OrderedViewFrame.l10n.formatSortActionTitle=function(D,C){return"Sortering is "+D+" ("+C+")";
};
Exhibit.OrderedViewFrame.l10n.formatRemoveOrderActionTitle=function(D,C){return"Verwijder sortering "+D+" ("+C+")";
};
...
Exhibit.OrderedViewFrame.l10n.formatDontShowAll=function(B){return"Toon alleen de eerste "+B+" resultaten";
};
Exhibit.OrderedViewFrame.l10n.formatShowAll=function(B){return"Toon alle "+B+" resultaten";
};
...
Exhibit.TabularView.l10n.makeSortActionTitle=function(C,D){return(D?"Sorteer oplopend ":"sorteer aflopend ")+C;
};
...
}Exhibit.ViewPanel.l10n.createSelectViewActionTitle=function(B){return"selecteer "+B+" toon";
};
Exhibit.ViewPanel.l10n.missingViewClassMessage="De beschrijving voor een van de zichten mist het viewClass-veld.";
Exhibit.ViewPanel.l10n.viewClassNotFunctionMessage=function(B){return"De waarde van het viewClass attribuut '"+B+"' die u heeft aangegeven\nvoor een van de zichten lijkt geen javascriptfunctie te zijn.";
};
Exhibit.ViewPanel.l10n.badViewClassMessage=function(B){return"De waarde van het viewClass attribuut '"+B+"' die u heeft aangegeven\nvoor een van de zichten lijkt geen javascriptexpressie te zijn.";
};
...
return String.substitute("<a class='exhibit-action exhibit-views-unplottableCount' href='javascript:void' id='unplottableCountLink'>%0</a> van <class class='exhibit-views-totalCount'>%1</span>  kan niet worden afgebeeld.",[F==1?(F+" result"):(F+" results"),H]);
};
