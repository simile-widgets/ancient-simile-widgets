...
var B=[];
var A=Exhibit.urlPrefix+"locales/sv/";
if(Exhibit.params.bundle){SimileAjax.includeJavascriptFiles(document,A,["exhibit-sv-bundle.js"]);
if(B.length>0){SimileAjax.includeCssFiles(document,A,["exhibit-sv-bundle.css"]);
}}else{SimileAjax.includeJavascriptFiles(document,A+"scripts/",D);
SimileAjax.includeCssFiles(document,A+"styles/",B);
}}})();


/* exhibit-sv-bundle.js */
...
Exhibit.l10n.badJsonMessage=function(C,D){return"JSON-filen\n  "+C+"\ninnehåller fel =\n\n"+D;
};
Exhibit.l10n.failedToLoadDataFileMessage=function(B){return"Kunde inte hitta filen\n  "+B+"\nKontrollera att filnamnet är korrekt.";
};
...
Exhibit.OrderedViewFrame.l10n.formatSortActionTitle=function(D,C){return"Sorterat efter "+D+" ("+C+")";
};
Exhibit.OrderedViewFrame.l10n.formatRemoveOrderActionTitle=function(D,C){return"Ta bort sorteringskriteriet "+D+" ("+C+")";
};
...
Exhibit.OrderedViewFrame.l10n.formatDontShowAll=function(B){return"Visa bara de första "+B+" resultaten";
};
Exhibit.OrderedViewFrame.l10n.formatShowAll=function(B){return"Visa samtliga "+B+" resultat";
};
...
Exhibit.TabularView.l10n.makeSortActionTitle=function(C,D){return"sortera efter "+(D?"stigande ":"fallande ")+C;
};
...
}Exhibit.ViewPanel.l10n.createSelectViewActionTitle=function(B){return"välj vyn "+B;
};
Exhibit.ViewPanel.l10n.missingViewClassMessage="Specifikationen för en av vyerna saknas i fältet viewClass.";
Exhibit.ViewPanel.l10n.viewClassNotFunctionMessage=function(B){return"Värdet '"+B+"' du angivit för attributet viewClass\nför en av dessa vyer var inte namnet på en javascriptfunktion.";
};
Exhibit.ViewPanel.l10n.badViewClassMessage=function(B){return"Värdet '"+B+"' du angivit för attributet viewClass\nför en av dessa vyer är inte ett giltigt javascriptuttryck.";
};
