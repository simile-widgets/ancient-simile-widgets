...
if(Exhibit.params.bundle){SimileAjax.includeJavascriptFiles(document,urlPrefix,["exhibit-zh-bundle.js"]);
if(cssFiles.length>0){SimileAjax.includeCssFiles(document,urlPrefix,["exhibit-zh-bundle.css"]);
