...
var B=[];
var A=Exhibit.urlPrefix+"locales/zh/";
if(Exhibit.params.bundle){SimileAjax.includeJavascriptFiles(document,A,["exhibit-zh-bundle.js"]);
if(B.length>0){SimileAjax.includeCssFiles(document,A,["exhibit-zh-bundle.css"]);
}}else{SimileAjax.includeJavascriptFiles(document,A+"scripts/",D);
SimileAjax.includeCssFiles(document,A+"styles/",B);
}}})();


/* exhibit-zh-bundle.js */
...
Exhibit.Database.l10n.labelItemsOfType=function(J,L,N,M){var P=Exhibit.Database.l10n.itemType.label;
var K="个";
var Q=N.getType(L);
if(Q){P=Q.getLabel();
var R=Q.getProperty("measureWord");
if(R){K=R;
}}var O=document.createElement("span");
O.innerHTML="<span class='"+M+"'>"+J+"</span>"+K+P;
return O;
};
