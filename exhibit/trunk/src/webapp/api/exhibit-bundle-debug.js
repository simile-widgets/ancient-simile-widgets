...
var elements;
try{elements=SimileAjax.jQuery('[ex\\:role="data"]').add('[data-ex-role="data"]');
}catch(e){elements=$("*").filter(function(){var attrs=this.attributes;
for(i=0;
i<attrs.length;
i++){if(((attrs[i].nodeName=="ex:role")||(attrs[i].nodeName=="data-ex-role"))&&(attrs[i].nodeValue=="data")){return true;
}}return false;
});
