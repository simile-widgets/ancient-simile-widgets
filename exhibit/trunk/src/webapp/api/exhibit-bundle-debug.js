...
}var babelURL="http://simile.mit.edu/babel/html-extractor?url="+encodeURIComponent(url);
...
Exhibit.Lens._processTemplateElement=function(elmt,isXML,uiContext){var templateNode={tag:elmt.tagName.toLowerCase()||"div",uiContext:uiContext,control:null,condition:null,content:null,contentAttributes:null,subcontentAttributes:null,attributes:[],styles:[],handlers:[],children:null};
