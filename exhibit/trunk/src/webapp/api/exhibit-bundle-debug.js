...
Exhibit.TabularView.prototype._stabilize=function(f,indexMap,lastIndex){var stable=function(item1,item2){var cmp=f(item1,items2);
if(cmp){return cmp;
}else{i1=indexMap[item1.id]||lastIndex;
i2=indexMap[item2.id]||lastIndex;
return i2-i1;
}};
return stable;
};
