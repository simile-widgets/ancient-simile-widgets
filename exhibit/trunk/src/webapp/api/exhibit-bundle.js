...
this._uiContext=B;
this._settings={rowStyler:null,tableStyler:null,lastIndex:{}};
this._columns=[];
...
Exhibit.TabularView.prototype._stabilize=function(C,B,D){var A=function(F,E){var G=C(F,items2);
if(G){return G;
}else{i1=B[F.id]||D;
i2=B[E.id]||D;
return i2-i1;
