...
Exhibit.SliderFacet.slider.prototype.resetSliders=function(){this._setSlider(this._slider1,this._range.min);
this._setSlider(this._slider2,this._range.max);
};
...
this._dom.minDisplay.innerHTML=C;
...
if(B._facet._settings.histogram){this.div.style.top=(this.div.offsetHeight-4)+"px";
}};
...
setTimeout(function(){var O=parseInt(H.div.style.left)+H.offset;
H.value=parseFloat(Exhibit.Util.round(O*B._scaleFactor+B._range.min,B._prec));
B._setDisplays(H);
},0);
};
};
