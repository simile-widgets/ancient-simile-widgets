...
this._minSlider={};
this._maxSlider={};
this._dom=SimileAjax.DOM.createDOMFromString(C,'<div class="exhibit-slider-bar" id="bar"><div class="exhibit-slider-handle" id="minHandle"></div><div class="exhibit-slider-handle" id="maxHandle"></div></div><div class="exhibit-slider-display"><span id="minDisplay"></span> - <span id="maxDisplay"></span></div>');
...
C.div.style.top=-C.div.offsetHeight/2+"px";
...
A.div.style.top=-A.div.offsetHeight/2+"px";
...
Exhibit.SliderFacet.slider.prototype._registerDragging=function(){self=this;
var A=function(E){return function(F){F=F||window.event;
onMove=B(F,E);
...
Exhibit.SliderFacet.slider.prototype._notifyFacet=function(){this._facet.changeRange({min:this._minSlider.value,max:this._maxSlider.value});
};
