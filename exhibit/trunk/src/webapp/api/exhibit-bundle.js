...
}var D="http://simile.mit.edu/babel/html-extractor?url="+encodeURIComponent(C);
if(B){D+="xpath="+B;
...
Exhibit.Lens._processTemplateElement=function(F,N,I){var D={tag:F.tagName.toLowerCase()||"div",uiContext:I,control:null,condition:null,content:null,contentAttributes:null,subcontentAttributes:null,attributes:[],styles:[],handlers:[],children:null};
