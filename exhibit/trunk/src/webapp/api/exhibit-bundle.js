...
Exhibit.Database._Impl.prototype.loadDataLinks=function(B){var A=$("head > link[rel=exhibit/data]").get();
this._loadLinks(A,B);
};
...
}var D=A._uiContext.getDatabase().getAllItems();
A.update(D);
}};
B.getCollection().addListener(this._listener);
};
...
this._dom=null;
var A=this;
this._listener={onRootItemsChanged:function(){var D=A._uiContext.getDatabase().getAllItems();
A.update(D);
}};
B.getCollection().addListener(this._listener);
};
