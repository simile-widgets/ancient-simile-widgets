...
if(!usingLens&&prefDim&&((srcDim.width<prefDim.width)||(srcDim.height<prefDim.height))){h='<span style="display:Inline-Block; position:Relative; width:'+srcDim.width+"px; height:"+srcDim.height+'px;">'+h+"</span>";
$(jq).replaceWith(h);
