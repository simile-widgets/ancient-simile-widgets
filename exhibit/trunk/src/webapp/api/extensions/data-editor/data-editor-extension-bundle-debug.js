...
$(this).append('<div class="'+Exhibit.DataEdit.EDIT_DIV+'"><div class="'+Exhibit.DataEdit.EDIT_BUTTON+'"><a href="javascript:Exhibit.DataEdit._edit_(\''+id+"')\">Edit</a></div></div>");
});
};
Exhibit.DataEdit._edit_=function(itemId){var self=this;
var filter=function(idx){return($(this).attr("ex:itemid"));
};
$("*").filter(filter).each(function(idx){$("."+Exhibit.DataEdit.EDIT_DIV,this).remove();
if($(this).attr("ex:itemid")==itemId){var editor=new Exhibit.DataEdit.Editor(itemId,this);
Exhibit.DataEdit._editors_[itemId]=editor;
editor.apply();
$(this).append('<div class="'+Exhibit.DataEdit.EDIT_DIV+'"><span class="'+Exhibit.DataEdit.EDIT_BUTTON+'"><a href="javascript:Exhibit.DataEdit._save_(\''+itemId+'\')">Save</a></span>&nbsp;&nbsp;<span class="'+Exhibit.DataEdit.EDIT_BUTTON+'"><a href="javascript:Exhibit.DataEdit._cancel_()">Cancel</a></span>&nbsp;&nbsp;<span id="'+Exhibit.DataEdit.EDIT_MESSAGE+'"></span></div>');
}});
};
Exhibit.DataEdit._save_=function(itemId){var self=this;
...
i++){var err=null;
var v=_vNames[i];
if(v.charAt(0)==="#"){v=v.toLowerCase();
if(v=="#notempty"){err=Exhibit.DataEdit.validateIsNotEmpty(val);
}else{if(v=="#isurl"){err=Exhibit.DataEdit.validateIsURL(val);
}}}else{if((window[v])&&(typeof window[v]=="function")){window[v](val);
}}if(err!=null){$("#"+Exhibit.DataEdit.EDIT_MESSAGE).html(err);
f.setError(true);
return ;
...
Exhibit.DataEdit.deactivate=function(){var self=this;
var filter=function(idx){return $(this).attr("ex:itemid");
};
Exhibit.DataEdit.log("deactivate()");
$("*").filter(filter).each(function(idx){$(this).click(null);
});
};
...
$(document).ready(function(){var filter=function(idx){return $(this).attr("ex:role")=="editorButton";
};
var l=$("*").filter(filter);
...
}else{var buttonHTML='<div style="position:Fixed; right:1em;  top:1em;"><div class="'+Exhibit.DataEdit.EDIT_BUTTON+'"><a href="javascript:Exhibit.DataEdit.activate();">Toggle editor</a></div></div>';
...
$(document).ready(function(){var filter=function(idx){return $(this).attr("ex:role")=="editor";
};
...
try{f=new Exhibit.DataEdit.Editor[c](this,self._itemId,prop,val);
...
Exhibit.DataEdit.Editor._isTrueFalse=function(s,def){def=(def==undefined)?false:def;
if(!s){return def;
}s=s.toLowerCase();
return(s==="true"||s==="yes");
};
...
Exhibit.DataEdit.Editor._getLineHeight2=function(el){var el2=document.createElement("div");
...
/* enum-field.js */
Exhibit.DataEdit.Editor.EnumField=function(jq,iid,pid,val){this._jqThis=jq;
this._itemId=iid;
this._propId=pid;
this._value=val;
...
var style=null;
if(this._matchDisplayLens){style=Exhibit.DataEdit.Editor._extractStyle(this._jqThis)+"border-width: 0px; width: "+$(this._jqThis).width()+"px; height: "+$(this._jqThis).height()+"px; ";
...
/* list-field.js */
Exhibit.DataEdit.Editor.ListField=function(jq,iid,pid,val){this._jqThis=jq;
this._itemId=iid;
this._propId=pid;
this._value=val;
this._divId="__DATAEDITOR__"+this._propId;
...
/* number-field.js */
Exhibit.DataEdit.Editor.NumberField=function(jq,iid,pid,val){this._jqThis=jq;
this._itemId=iid;
this._propId=pid;
this._value=val;
this._divId="__DATAEDITOR__"+this._propId;
...
if(this._matchDisplayLens){style=Exhibit.DataEdit.Editor._extractStyle(this._jqThis)+"border-width: 0px; width: "+$(this._jqThis).width()+"px; height: "+$(this._jqThis).height()+"px; ";
}var tag=Exhibit.DataEdit.Editor._htmlTag("input",{"id":this._divId,"style":style,"class":"exhibitDataEditNumberField","type":"Text","value":this._value},$(this._jqThis).get()[0],true);
return tag;
};
...
/* text-field.js */
Exhibit.DataEdit.Editor.TextField=function(jq,iid,pid,val){this._jqThis=jq;
this._itemId=iid;
this._propId=pid;
this._value=val;
this._divId="__DATAEDITOR__"+this._propId;
this._validators=null;
this._matchDisplayLens=false;
this._largeText=Exhibit.DataEdit.Editor._isTrueFalse($(jq).attr("ex:large"));
...
Exhibit.DataEdit.Editor.TextField.prototype.getHTML=function(onShow){var style=null;
if(this._matchDisplayLens){style=Exhibit.DataEdit.Editor._extractStyle(this._jqThis)+"border-width: 0px; width: "+$(this._jqThis).width()+"px; height: "+$(this._jqThis).height()+"px; ";
var h1=$(this._jqThis).height();
var h2=$(this._jqThis).css("line-height");
if(h1&&h2){h2=parseInt(h2.replace(/px/,""));
this._largeText=((h1/h2)>=2);
}}if(this._largeText){var c=this._cols?this._cols:null;
var r=this._rows?this._rows:null;
var tag=Exhibit.DataEdit.Editor._htmlTag("textarea",{"id":this._divId,"style":style,"class":"exhibitDataEditTextArea","rows":r,"cols":c},$(this._jqThis).get()[0],false);
return tag+this._value+"</textarea>";
}else{var tag=Exhibit.DataEdit.Editor._htmlTag("input",{"id":this._divId,"style":style,"class":"exhibitDataEditTextField","type":"Text","value":this._value},$(this._jqThis).get()[0],true);
return tag;
}};
