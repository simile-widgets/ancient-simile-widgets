...
var A=Exhibit.DataEdit.Editor._htmlTag("textarea",{"id":this._divId,"style":E,"class":"exhibitDataEditTextAreaField","rows":F,"cols":G,"onchange":B},$(this._jqThis).get()[0],false);
...
console.log(K,(K.value.toLowerCase()===G));
