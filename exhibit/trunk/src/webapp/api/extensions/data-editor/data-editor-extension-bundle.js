...
var E=function(M){return $(this).attr("_ex:role")==Exhibit.DataEdit.EDIT_ROLE_EDIT;
};
var F=$("*",this).filter(E);
...
var C=function(M){return $(this).attr("_ex:role")==Exhibit.DataEdit.EDIT_ROLE_DELETE;
};
$("*",this).filter(C).each(function(M){$(this).css("display","Block");
$(this).click(function(){Exhibit.DataEdit.de1ete(D);
});
});
var I=function(M){return $(this).attr("_ex:role")==Exhibit.DataEdit.EDIT_ROLE_CLONE;
};
...
var G='<div class="'+Exhibit.DataEdit.EDIT_INJECT_MARKER+'" onMouseOver="Exhibit.DataEdit._rollIn_(this)" onMouseOut="Exhibit.DataEdit._rollOut_(this)" style="position:Absolute ; top:'+L.top+"px ; left:"+L.left+"px ; width:"+J+"px ; height:"+H+'px ; cursor:Help ; border:2px #dddddd Dotted;"><div onclick="Exhibit.DataEdit.edit(\''+D+'\')" style="width:'+J+"px ; height:"+H+'px ; background:Black; opacity:0.0; filter:alpha(opacity=0); -ms-filter:"progid:DXImageTransform.Microsoft.Alpha(Opacity=0);"></div><div class="__buttonBar__" style="position:Absolute ; top:4px ; right: 2px ; display:None;"><span onclick="Exhibit.DataEdit.clone(\''+D+'\')" style="background:Red ; color:White ; padding:0.25em 0.5em ; cursor:Pointer ; margin-right:10px;">Clone</span><span onclick="Exhibit.DataEdit.de1ete(\''+D+'\')" style="background:Red ; color:White ; padding:0.25em 0.5em ; cursor:Pointer ;">Delete</span></div></div>';
$(this).append(G);
}});
