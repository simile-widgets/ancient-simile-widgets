...
var E=function(N){return $(this).attr("_ex:role")==Exhibit.DataEdit.EDIT_ROLE_EDIT;
};
var F=$("*",this).filter(E);
...
var C=function(N){return $(this).attr("_ex:role")==Exhibit.DataEdit.EDIT_ROLE_DELETE;
};
$("*",this).filter(C).each(function(N){$(this).css("display","Block");
$(this).click(function(){Exhibit.DataEdit.de1ete(D);
});
});
var I=function(N){return $(this).attr("_ex:role")==Exhibit.DataEdit.EDIT_ROLE_CLONE;
};
$("*",this).filter(I).each(function(N){$(this).css("display","Block");
$(this).click(function(){Exhibit.DataEdit.clone(D);
});
});
var J=function(N){return $(this).attr("_ex:role")==Exhibit.DataEdit.EDIT_ROLE_CREATE;
};
...
if(!A&&B&&((C.width<B.width)||(C.height<B.height))){D='<span style="display:Inline-Block; position:Relative; width:'+C.width+"px; height:"+C.height+'px;">'+D+"</span>";
$(H).replaceWith(D);
