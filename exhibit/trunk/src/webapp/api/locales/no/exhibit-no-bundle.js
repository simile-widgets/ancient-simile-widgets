...
Exhibit.Database.l10n.uriProperty={label:"URI",pluralLabel:"URIer",reverseLabel:"URI for",reversePluralLabel:"URIer for"};
Exhibit.Database.l10n.sortLabels={"tekst":{ascending:"a - å",descending:"å - a"},"tall":{ascending:"minste først",descending:"største først"},"dato":{ascending:"yngste først",descending:"elste først"},"boolsk":{ascending:"usann først",descending:"sann først"},"objekter":{ascending:"a - å",descending:"å - a"}};
...
Exhibit.OrderedViewFrame.l10n.sortingControlsTemplate="sortert etter: <span id='ordersSpan'></span>; <a id='thenSortByAction' href='javascript:void' class='exhibit-action' title='deretter sorter etter'>så etter...</a>";
