...
Exhibit.BrowseEngine.l10n={errorParsingFacetExpressionMessage:function(expression){return"Uttrycket '"+expression+"' f\xD6r att ange facett \xE4r ogiltigt.";}};
...
Exhibit.OrderedViewFrame.l10n={thenSortByLabel:"och sedan efter...",removeOrderLabel:"Ta bort det h\xE4r sorteringskriteriet",formatSortActionTitle:function(propertyLabel,sortLabel){return"Sorterat efter "+propertyLabel+" ("+sortLabel+")";},formatRemoveOrderActionTitle:function(propertyLabel,sortLabel){return"Ta bort sorteringskriteriet "+propertyLabel+" ("+sortLabel+")";},resetActionTitle:"≈terst\xE4ll",formatDontShowAll:function(limitCount){return"Visa bara de f\xD6rsta  "+limitCount+" resultaten";},formatShowAll:function(count){return"Visa samtliga "+count+" result";},createSortingControlsTemplate:function(thenSortByActionLink){return["sorterat efter: ",{tag:"span",field:"ordersSpan"},"; ",{elmt:thenSortByActionLink,title:"sortera ytterligare",field:"thenByLink"}];},groupedAsSorted:"gruppera som de sorterats",groupAsSortedActionTitle:"grupperade som de sorterats",ungroupActionTitle:"ogrupperade",showDuplicates:"visa dubletter",showDuplicatesActionTitle:"visa dubletter",hideDuplicatesActionTitle:"g\xD6m dubletter"};

/* tabular-view-l10n.js */

Exhibit.TabularView.l10n={viewLabel:"Tabell",viewTooltip:"Visa i tabell",resetActionTitle:"≈terst\xE4ll",columnHeaderSortTooltip:"Klicka f\xD6r att sortera efter den h\xE4r kolumnen",columnHeaderReSortTooltip:"Klicka f\xD6r att v\xE4lja omv\xE4nd ordning",makeSortActionTitle:function(label,ascending){return"sortera efter "+(ascending?"stigande ":"fallande ")+
label;}};
...
Exhibit.ViewPanel.l10n={resetFiltersLabel:"\xE5terst\xE4ll",createSelectViewActionTitle:function(viewLabel){return"v\xE4lj vyn "+viewLabel;},createNoResultsTemplate:function(countClass,typesClass,detailsClass){return[{tag:"span",className:countClass,children:["0"]},{tag:"span",className:typesClass,children:[" resultat"]},". ",{tag:"span",className:detailsClass,children:["V\xE4lj bort n\xE5gra filter f\xD6r fler resultat."]}];},createResultsSummaryTemplate:function(countClass,typesClass,detailsClass,resetActionLink){return[{tag:"span",className:countClass,field:"itemCountSpan"},{tag:"span",className:typesClass,field:"typesSpan"},{tag:"span",className:detailsClass,field:"noFilterDetailsSpan",style:{display:"none"},children:["totalt"]},{tag:"span",className:detailsClass,field:"filteredDetailsSpan",style:{display:"none"},children:[" filtrerade fr\xE5n ",{tag:"span",field:"originalCountSpan"}," av ursprungliga (",{elmt:resetActionLink,title:"V\xE4lj bort alla filter och se samtliga"},")"]}];},missingViewClassMessage:"Specifikationen f\xD6r en av vyerna saknas i f\xE4ltet viewClass.",viewClassNotFunctionMessage:function(expr){return"V\xE4rdet '"+expr+"' du angivit f\xD6r attributet viewClass\n"+"f\xD6r en av dessa vyer var inte namnet p\xE5 en javascriptfunktion.";},badViewClassMessage:function(expr){return"V\xE4rdet '"+expr+"' du angivit f\xD6r attributet viewClass\n"+"f\xD6r en av dessa vyer \xE4r inte ett giltigt javascriptuttryck.";}};
